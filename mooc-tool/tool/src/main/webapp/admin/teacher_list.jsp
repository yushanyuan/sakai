...
<table  class="listHier lines nolines">
	<tr><th>姓名</th><th>头像</th><th>简介</th><th>操作</th></tr>
	<c:forEach items="${list }" var="t">
		<tr><td>${t.name }</td><td><img width="80px" height="80px" src="${moocServer }${t.image }"/></td><td>${t.profile }</td><td><a href="remove.htm?id=${t.id }">[删除]</a>  <a href="edit.htm?id=${t.id }">[修改]</a></td></tr>
	</c:forEach>
</table>
 <ul id="actionToolBar" class="navIntraTool actionToolBar">
	<li class="firstToolBarItem"><span><a href="add.htm">添加老师</a></span></li>
</ul>
