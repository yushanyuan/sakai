...
public class DOMTreeUtility
{
   ...
   public static Node getNode( Node iNode, String iNodeName )
   {
      ...
      Logger.getLogger("org.adl.util.debug.samplerte").finest("Parent Node: " + iNode.getLocalName());
      Logger.getLogger("org.adl.util.debug.samplerte").finest("Node being searched for: " + iNodeName);
      ...
      if ( iNode != null )
      {
         ...
         if ( children != null )
         {
            for ( int i = 0; i < children.getLength(); i++ )
            {
               ...
               Logger.getLogger("org.adl.util.debug.samplerte").finest("Child #" + i + ": " + currentChildName);
                                    ...
                                    String iAttributeName )
   {
      ...
      Logger.getLogger("org.adl.util.debug.samplerte").finest("Parent Node: " + iNode.getLocalName());
      Logger.getLogger("org.adl.util.debug.samplerte").finest("Node being searched for: " + iAttributeName);
      Attr result = null;
