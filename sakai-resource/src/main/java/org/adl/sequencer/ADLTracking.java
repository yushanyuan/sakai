...
public class ADLTracking implements Serializable
{
    ...
    * 
    * @return The Activity current completion status.   
    */
    ...
    * the activity status may be set based on a threshold evaluation.
    * 
    ...
    * 
    * @return The Activity current progress measure.   
    */
