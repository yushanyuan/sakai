	...
	<div class="main-B">
	  ...
	  <div class="c-1">
	       <table width="97%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td width="10%"><img src="resource/images/template/index1-lie-left-G.jpg" width="140" height="61" /></td>
		...
		<div class="zhang-jie">
	       <table border="0" cellpadding="0" cellspacing="0" width="96%" >
		 			<tr>
               			 <td width="60%" class="z-jie1"><a href="location.href='studySpace_fowardTemplateRGBModule.do?moduleId=<%=id%>&studyrecordId=<%=studyRecordId%>&template=index-1G'"><%=title %></a></td>
						 <td width="10%" ></td>
		...
		<div class="c-1">
			...
			%>
			<div class="f-left">
				<div class="f1"><img src="resource/images/template/index1-c1-G.jpg" width="76" height="69" /></div>
			...
			%>
			<div class="f-left">
				<div class="f1"><img src="resource/images/template/index1-c2-G.jpg" width="76" height="69" /></div>
				<div class="f2">同学们可以通过这里进行学习。</div>
				<div class="celss"></div>
				<div class="f3">
					<table border="0" cellpadding="0" cellspacing="0" width="96%" >
			...
			%>
			<div class="f-left">
				<div class="f1"><img src="resource/images/template/index1-c3-G.jpg" width="76" height="69" /></div>
				<div class="f2">同学们可以通过这里进行学习。</div>
				<div class="celss"></div>
				<div class="f3">
					<table border="0" cellpadding="0" cellspacing="0" width="96%" >
