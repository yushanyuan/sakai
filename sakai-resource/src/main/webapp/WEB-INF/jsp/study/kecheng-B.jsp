...
<script type=text/javascript>
	...
	{	
		...
		for(j=0;j<nodeListSize;j++) {
			if(j==i) {
				document.getElementById("font" + samaArray[i]).style.color="#1f70b1";
			} else {
