...
<script type=text/javascript>
	...
	function selectTab03Syn (i,nodeListSize)
	{
		...
		for(j=0;j<nodeListSize;j++) {
			if(j==i) {
				document.getElementById("font" + samaArray[i]).style.color="#960000";
			} else {
				...
				<div class="zhang-z0"></div>
					...
					<div class="zhang-an">
						<div id=TabTab03Con01>
							...
							<div class="times">
								<p>建议时长：<img src="resource/images/template/time.jpg" width="10" height="10" />&nbsp;<span id ="studyTime"><%=rightStudyTimeInit%></span>分钟</p>
								<p>我的时长：<img src="resource/images/template/time.jpg" width="10" height="10" />&nbsp;<span id ="myTime"><%=rightMyTimeInit%></span>分钟</p>
							</div>
